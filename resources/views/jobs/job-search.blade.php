                    ...
                    <div class="row m-0">
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                            <div class="form-group">
                                <i class="ti-search"></i>
                                <input id="topFilterJobTitle" type="text" class="form-control b-r"
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                            <div class="form-group">
                                ...
                                <input id="topFilterLocation" type="text" class="form-control b-r"
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 p-0">
                            <div class="form-group">
                                ...
                                <input id="topFilterCompanyName" type="text" class="form-control b-r"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="side-imbo">
                                            <ul class="no-ul-list" id="checkBoxFilterSkill">
                                                ...
                                                @foreach($tags as $tag)
                                                    <li>
                                                        <input id="checkbox-skill-{{$loop->iteration}}" class="checkbox-custom"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="layout-switcher-wrap">
                                    <div
                                        class="layout-switcher-left" id="totalResultsInfo">{{$jobs->total().' '.__(trans_choice('jobs/jobs.results',$jobs->total()))}}</div>
                                </div>
                            </div>
                        </div>
