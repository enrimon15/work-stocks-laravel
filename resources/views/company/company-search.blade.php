							...
							<ul class="nav-menu">
								...
								<li><a href="#">For Employers<span class="submenu-indicator"></span></a>
									<ul class="nav-dropdown nav-submenu" style="right: auto; display: none;">
										...
										<li><a href="company-dashboard.blade.php">Employer Dashboard</a></li>
									</ul>
								</li>
								...
								<div class="col-md-12 mb-1">
									<div class="layout-switcher-wrap">
										...
										<div class="layout-switcher">
											<ul>
												<li class="active"><a href="company-search.blade.php"><i class="ti-layout-grid3"></i></a></li>
							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-4 col-sm-6">
									<div class="employer-wrap small">
										...
										<div class="employer-cover-image" style="background-image: url(https://via.placeholder.com/1280x820)">
											<div class="employer-thumb">
												<a href="#"><img alt="" src="https://via.placeholder.com/90x90" class="avatar avatar-120 photo"></a>
											</div>
										</div>
										<div class="employer-detail">
											<div class="employer-detail-inner">
												<h4 class="employer-title"><a class="theme-cl" href="#">Adword Soft</a></h4>
												<div class="employer-locations"><i class="ti-location-pin text-danger"></i><a href="#">Canada, USA</a></div>
												...
												<a class="total-vacancy text-success" href="#">View all 3 Job Positions</a>
											</div>
										</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-6">
									<div class="employer-wrap small">
										...
										<div class="employer-detail">
											<div class="employer-detail-inner">
												<h4 class="employer-title"><a class="theme-cl" href="#">Asana Tech</a></h4>
												...
												<a class="total-vacancy text-success" href="#">View all 35 Job Positions</a>
											</div>
										</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-6">
									<div class="employer-wrap small">
										...
										<div class="employer-detail">
											<div class="employer-detail-inner">
												<h4 class="employer-title"><a class="theme-cl" href="#">Bing Sois</a></h4>
												<div class="employer-locations"><i class="ti-location-pin text-danger"></i><a href="#">Brazil, USA</a></div>
												<div class="employer-rating">
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
													<i class="ti-starfilled"></i>
												</div>
												<a class="total-vacancy text-success" href="#">View all 12 Job Positions</a>
											</div>
										</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-6">
									<div class="employer-wrap small">
										...
										<div class="employer-detail">
											<div class="employer-detail-inner">
												<h4 class="employer-title"><a class="theme-cl" href="#">Google Pvt</a></h4>
												<div class="employer-locations"><i class="ti-location-pin text-danger"></i><a href="#"><a href="#">England</a></div>
												<div class="employer-rating">
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
												...
												<a class="total-vacancy text-success" href="#">View all 30 Job Positions</a>
											</div>
										</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-6">
									<div class="employer-wrap small">
										...
										<div class="employer-detail">
											<div class="employer-detail-inner">
												<h4 class="employer-title"><a class="theme-cl" href="#">Drive Soft</a></h4>
												<div class="employer-locations"><i class="ti-location-pin text-danger"></i><a href="#">Canada, USA</a></div>
												<div class="employer-rating">
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
												...
												<a class="total-vacancy text-success" href="#">View all 13 Job Positions</a>
											</div>
										</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-6">
									<div class="employer-wrap small">
										...
										<div class="employer-detail">
											<div class="employer-detail-inner">
												<h4 class="employer-title"><a class="theme-cl" href="#">Phonix Soft</a></h4>
												<div class="employer-locations"><i class="ti-location-pin text-danger"></i><a href="#">Australia</a></div>
												<div class="employer-rating">
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
												...
												<a class="total-vacancy text-success" href="#">View all 45 Job Positions</a>
											</div>
										</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-6">
									<div class="employer-wrap small">
										...
										<div class="employer-cover-image" style="background-image: url(https://via.placeholder.com/1280x820)">
											<div class="employer-thumb">
												<a href="company-details.blade.php"><img alt="" src="https://via.placeholder.com/90x90" class="avatar avatar-120 photo"></a>
											</div>
										</div>
										<div class="employer-detail">
											<div class="employer-detail-inner">
												<h4 class="employer-title"><a class="theme-cl" href="#">PayPal</a></h4>
												<div class="employer-locations"><i class="ti-location-pin text-danger"></i><a href="#"><a href="#">New York, US</a></div>
												<div class="employer-rating">
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
												...
												<a class="total-vacancy text-success" href="company-details.blade.php">View all 5 Job Positions</a>
											</div>
										</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-6">
									<div class="employer-wrap small">
										...
										<div class="employer-detail">
											<div class="employer-detail-inner">
												<h4 class="employer-title"><a class="theme-cl" href="#">Elix Soft</a></h4>
												<div class="employer-locations"><i class="ti-location-pin text-danger"></i><a href="#">California, USA</a></div>
												<div class="employer-rating">
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
												...
												<a class="total-vacancy text-success" href="company-details.blade.php">View all 12 Job Positions</a>
											</div>
										</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-6">
									<div class="employer-wrap small">
										...
										<div class="employer-detail">
											<div class="employer-detail-inner">
												<h4 class="employer-title"><a class="theme-cl" href="#">Atlassian Pvt</a></h4>
												<div class="employer-locations"><i class="ti-location-pin text-danger"></i><a href="#">London, UK</a></div>
												<div class="employer-rating">
													<i class="ti-star filled"></i>
													<i class="ti-star filled"></i>
												...
												<a class="total-vacancy text-success" href="company-details.blade.php">View all 10 Job Positions</a>
											</div>
										</div>
