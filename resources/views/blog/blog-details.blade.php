				...
				<div class="container">
					<div class="col-lg-12 col-md-12">
						<div class="pt-caption text-center">
							<h1>Blog Detail</h1>
							<p><a href="index.html">Home</a><span class="current-page">Blog Detail</span></p>
						</div>
					</div>
				</div>
			</div>
							...
							<article class="blog-news big-detail-wrap">
								<div class="blog-detail-wrap">
									...
									<figure class="img-holder">
										<a href="blog-details.blade.php"><img src="https://via.placeholder.com/1280x820" class="img-responsive" alt="News"></a>
