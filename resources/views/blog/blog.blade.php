						...
						<div class="nav-menus-wrapper" style="transition-property: none;">
							<ul class="nav-menu">
								...
								<li><a href="#">Pages<span class="submenu-indicator"></span></a>
									<ul class="nav-dropdown nav-submenu" style="right: auto; display: none;">
										<li><a href="blog.blade.php">Blogs Page</a></li>
										<li><a href="blog-details.blade.php">Blog Detail</a></li>
				...
				<div class="container">
					<div class="col-lg-12 col-md-12">
						<div class="pt-caption text-center">
							...
							<p><a href="index.html">Home</a><span class="current-page">Blog</span></p>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-4">
							<div class="blog-grid-wrap mb-4">
								<div class="blog-grid-thumb">
									<a href="blog-details.blade.php"><img src="https://via.placeholder.com/1280x820" class="img-responsive" alt="" /></a>
								...
								<div class="blog-grid-content">
									<h4 class="cnt-gb-title"><a href="blog-details.blade.php">Why most People used bootstrap framework?</a></h4>
						...
						<div class="col-lg-4 col-md-4">
							<div class="blog-grid-wrap mb-4">
								...
								<div class="blog-grid-content">
									<h4 class="cnt-gb-title"><a href="blog-details.blade.php">drizvato Launch New & powerful template</a></h4>
									<p>In varius varius justo, eget ultrices mauris rhoncus non. Morbi tristique, mauris eu bibendum, velit diam.</p>
								</div>
								<div class="blog-grid-meta">
									<div class="gb-info-author">
						...
						<div class="col-lg-4 col-md-4">
							<div class="blog-grid-wrap mb-4">
								...
								<div class="blog-grid-content">
									<h4 class="cnt-gb-title"><a href="blog-details.blade.php">Which Features is best in drizvato Theme?</a></h4>
									<p>In varius varius justo, eget ultrices mauris rhoncus non. Morbi tristique, mauris eu bibendum, velit diam.</p>
								</div>
								<div class="blog-grid-meta">
									<div class="gb-info-author">
